...
const index_1 = require("../templates/app/index");
class AppCreator {
    constructor(fd, command) {
        this.fd = fd;
    ...
    createMainTypeScriptFile() {
        const toWrite = index_1.mainTemplate(pascalCase(this.fd.info.name));
    ...
    runNpmInstall() {
        return new Promise((resolve, reject) => {
            child_process_1.exec('npm install', {
                cwd: this.fd.folder,
            }, (e) => {
                if (e) {
                    reject();
